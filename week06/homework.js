function match1(str) {
  return !~[...str].findIndex((i) => i === "a") ? false : true;
}
console.log("true", match1("hello world a."));
function match2(str) {
  return [...str].reduce((pre, i) => {
    if (pre === "a" && i === "b") {
      return true;
    }
    if (pre === true) {
...
console.log("true", match2("I ab man"));
console.log("false", match2("I a man"));
